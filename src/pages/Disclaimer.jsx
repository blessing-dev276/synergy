  ...
  return (
    <>
      <PageMeta
        ...
        description="SynergyTeam's income disclaimer for the freelancing and network marketing tracks."
      />
      ...
      <section style={{ paddingTop: 8 }}>
        <div className="wrap">
          <div className="prose">
            ...
            <p>
              Any income figures, examples, or success stories mentioned or
              implied anywhere on this site, in team chats, or in conversations
              with team members are not typical and are not guaranteed. Your
              results will depend on your own effort, skill, consistency, market
              conditions, and factors outside SynergyTeam's control.
            </p>

            <h2>Freelancing track</h2>
            <p>
              The freelancing track provides training, mentorship, and gig-setup
              support. It does not guarantee clients, bookings, or any specific
              income. Freelance platforms such as Fiverr and Upwork set their
              own rules and fees, which are outside our control and may change
              at any time.
            </p>
            ...
            <p>
              ...
              Consider your own circumstances, and consult a qualified
              professional where appropriate, before making financial decisions.
            </p>

            <h2>Questions</h2>
            <p>
              If anything here is unclear, ask us directly before you apply —
              reach us at <a href={`mailto:${SITE.email}`}>{SITE.email}</a> or
              via WhatsApp from the <Link to="/join">Join</Link> page.
            </p>
          </div>
        </div>
      </section>
